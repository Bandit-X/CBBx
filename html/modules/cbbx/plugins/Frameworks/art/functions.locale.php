...
if (!class_exists("XoopsLocal")) {
	...
	if (!@include_once FRAMEWORKS_ROOT_PATH ."/compat/language/".$GLOBALS["xoopsConfig"]["language"]."/local.php") {
		require_once FRAMEWORKS_ROOT_PATH ."/compat/language/english/local.php";
	}
} else {
