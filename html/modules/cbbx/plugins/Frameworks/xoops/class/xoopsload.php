...
class XoopsLoad
{
    ...
    public static function loadCore($name)
    {
        ...
        if (isset($configs[$name])) {
            ...
            return true;
        } elseif (file_exists($file = FRAMEWORKS_ROOT_PATH . '/xoops/class/' . $name . '.php')) {
            include_once $file;
    ...
    {
        if (!file_exists($file = FRAMEWORKS_ROOT_PATH . '/' . $name . '/xoops' . $name . '.php')) {
    ...
    public static function loadCoreConfig()
    {
        return $configs = array(
            'xoopsuserutility'           => FRAMEWORKS_ROOT_PATH . '/xoops/class/userutility.php',
            ...
            'xoopscache'                 => FRAMEWORKS_ROOT_PATH . '/xoops/class/cache/xoopscache.php',
            'xoopsfile'                  => FRAMEWORKS_ROOT_PATH . '/xoops/class/file/xoopsfile.php',
            ...
            'xoopslocal'                 => FRAMEWORKS_ROOT_PATH . '/xoops/include/xoopslocal.php',
            'xoopslocalabstract'         => FRAMEWORKS_ROOT_PATH . '/xoops/class/xoopslocal.php',
 ...
 * XMF libraries
 */
include_once FRAMEWORKS_ROOT_PATH . '/xoops/class/libraries/vendor/autoload.php';
