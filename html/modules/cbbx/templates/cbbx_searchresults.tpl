  ...
  <tr>
    <td><table border="0" cellpadding="4" cellspacing="1" width="100%">
        <tr class="head" align="center">
          <td><{$smarty.const._MD_CBBX_FORUMC}></td>
          <td><{$smarty.const._MD_CBBX_SUBJECT}></td>
          <td><{$smarty.const._MD_CBBX_AUTHOR}></td>
          <td nowrap="nowrap"><{$smarty.const._MD_CBBX_POSTTIME}></td>
        </tr>
