...
<div id="forum_header">
<div><{$folder_topic}> <a href="<{$smarty.const.CBBX_URL}>/index.php"><{$forum_index_title}></a></div>
<div>&nbsp;&nbsp;<{$folder_topic}><a href="<{$current_link}>"><{$current_type}></a></div>
</div>
...
<a href="<{$smarty.const.CBBX_URL}>/viewall.php?mode=1#admin" target="_self" title="<{$smarty.const._MD_CBBX_TYPE_ADMIN}>"><{$smarty.const._MD_CBBX_TYPE_ADMIN}></a>
<{elseif $mode eq 1}>
...
<a href="<{$smarty.const.CBBX_URL}>/viewall.php?mode=0" target="_self" title="<{$smarty.const._MD_CBBX_TYPE_VIEW}>"><{$smarty.const._MD_CBBX_TYPE_VIEW}></a> 
<{else}>
<a href="<{$smarty.const.CBBX_URL}>/viewall.php?mode=1#admin" target="_self" title="<{$smarty.const._MD_CBBX_TYPE_ADMIN}>"><{$smarty.const._MD_CBBX_TYPE_ADMIN}></a>
<{/if}>
</div>
...
<table class="outer" cellpadding="6" cellspacing="1" border="0" width="100%" align="center">
    ...
    <tr class="head" align="left">
		...
		<td width="15%" align="center" nowrap="nowrap"><strong><a href="<{$h_forum_link}>"><{$smarty.const._MD_CBBX_FORUM}></a></strong></td>
...
<{foreach name=loop item=topic from=$topics}>
  <tr class="<{cycle values="even,odd"}>">
    ...
    <td align="right" valign="middle"><{$topic.topic_last_posttime}><br />
		<{$smarty.const._MD_CBBX_BY}> <{$topic.topic_last_poster}>
	</td>
  </tr>
<{/foreach}>
  <!-- end forum topic -->
  ...
  <tr class="foot">
    <td colspan="8" align="center"> <{strip}>
...
<{if $forum_pagenav}>
<div style="float: right; text-align:right; padding: 5px;"><{$forum_pagenav}></div>
<br />
<{/if}>
<div class="clear"></div>
